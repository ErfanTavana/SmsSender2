"""
Django settings for SmsSender2 project.
...
SECRET_KEY = 'django-insecure-cuxl1d2$1l(8l@e=a(pqmda=3$wh1+!oa#lnyadrzu6+x_)_v%'
...
WSGI_APPLICATION = 'SmsSender2.wsgi.application'
